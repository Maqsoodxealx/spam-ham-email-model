...
The dataset contains thousands of labeled SMS messages categorized into two classes: Spam and Ham
## Technologies Used
•	Python	
•	Google Colab
•	PyCharm
...
## Exploratory Data Analysis (EDA) : Several visualizations were created for better understanding the dataset.
•	Class Distribution                                                                                              
•	Count Plot                                                                                            
•	Pie Chart                                                                                                            
## Observations
...
Frequently Appearing Spam Words : Free, win, claim, call, txt, reply                                                   Frequently Appearing Ham Words : ok, now, go, call, will                                                                
...
BaggingClassifier (0.958414, 0.868217)                                                        
...
## Future Improvements : Potential enhancements include:   
...
•	Data Science                                                                                                              
## Acknowledgements
Special thanks to my teachers : Zafar Iqbal & Hisham Sarwar                                                                  
## License
